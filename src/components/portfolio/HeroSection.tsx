...
const HeroSection = () => {
  // const { scene } = useGLTF("/assets/3d/cube.glb");
  return (
    // <LiquidGlassTheme>
    ...
    >
      ...
      {/* <div className="w-full h-[100dvh] absolute top-0 left-0 pointer-events-none blur-sm">
        <Ballpit
          count={20}
          gravity={0}
          friction={1}
      ...
      <div className="relative z-10 container-tight text-center px-4">
        <div className="relative w-[200px] h-[40px] mx-auto">
          <GlassSurface
            displace={0.5}
            distortionScale={-180}
            redOffset={0}
        ...
        <motion.p
          className="text-base md:text-base text-white max-w-xl mx-auto mb-10 text-balance"
        ...
        >
          <MagneticButton strength={0.4}>
            <Button className="cursor-target" variant="hero" size="lg" asChild>
              <a href="#projects">
                View Work
