...
(function () {
  ...
  function init() {
    const MODEL_PATH = "/Character.fbx";
  ...
  function playOnClick() {
    ...
    playModifierAnimation(idle, 0.25, possibleAnims[anim], 0.25); //6
  }
